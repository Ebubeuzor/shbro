...
<head>
    ...
    <title>New Apartment Listing Created by [Cohost Name] – Action Required</title>
    <style>
...
<body style="margin: 0 !important; padding: 0 !important; background-color: #f4f4f4;" bgcolor="#f4f4f4">
    <div style="display: none; font-size: 1px; color: #fefefe; line-height: 1px; font-family: Arial, sans-serif; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">
        New Apartment Listing Created by [Cohost Name] – Action Required
    </div>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td align="center" style="font-size: 24px; font-family: Arial, sans-serif; color: #333333; padding-top: 30px; padding-bottom: 20px;" class="padding">
                                        <strong>New Apartment Listing Created by [Cohost Name] – Action Required</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Arial, sans-serif; color: #666666;" class="padding">
                                        ...
                                        <ul>
                                            <li><strong>Apartment title:</strong> [Apartment Title]</li>
                                            <li><strong>Number of rooms:</strong> [Number of Rooms]</li>
                                            <li><strong>Number of bathrooms:</strong> [Number of Bathrooms]</li>
                                            <li><strong>Additional amenities:</strong> [Any Additional Details]</li>
                                        </ul>
                                        <p>As the primary host, you have the option to review and approve or delete the new listing. Please take a moment to ensure the accuracy of the information before confirming the listing.</p>
                                        <p><strong>Review and Approve:</strong> <a href="[Link to Listing Details]">Click here to review listing details</a></p>
