...
const AlertCard = ({ title, description, link, houseTitle }) => {
  return (
    <div className="flex space-x-5">
      <div className=" cursor-pointer relative justify-between border rounded-lg p-4 h-64 items-center space-x-4  w-64">
        <div className="">
          ...
          <div>
            <span className="text-red-600 text-sm">{description}</span>
          </div>
          <div>
            <span className="text-gray-600 font-semibold text-sm">{houseTitle}</span>
          </div>
