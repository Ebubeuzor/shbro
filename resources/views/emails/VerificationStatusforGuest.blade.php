...
<head>
    ...
    <title>Government ID Verification Status for Your Upcoming Guest</title>
    <style>
...
<body style="margin: 0 !important; padding: 0 !important; background-color: #f4f4f4;" bgcolor="#f4f4f4">
    <div style="display: none; font-size: 1px; color: #fefefe; line-height: 1px; font-family: Arial, sans-serif; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">
        Government ID Verification Status for Your Upcoming Guest.
    </div>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td align="center" style="font-size: 24px; font-family: Arial, sans-serif; color: #333333; padding-top: 30px; padding-bottom: 20px;" class="padding">
                                        <strong>Government ID Verification Status for Your Upcoming Guest</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Arial, sans-serif; color: #666666;" class="padding">
                                        <p>Hello [Host Name],</p>
                                        <p>We want to keep you informed about the government ID verification status of your upcoming guest, [Guest Name]. The verification is <strong>[Status: under review/approved/not approved]</strong>. We will notify you of any updates or necessary actions related to this booking.</p>
