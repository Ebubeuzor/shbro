                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td align="left" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Arial, sans-serif; color: #666666;" class="padding">
                                        ...
                                        <p>Please ensure that your listing complies with all relevant Shrbo rules and regulations. Additionally, as part of the approval process, we require a valid **utility bill** that shows proof of address. This document helps verify the accuracy of your listing's location. You can upload this through your host dashboard immediately to avoid delays.</p>
                                        <p>If you need to make any corrections or updates to the listing while it is under review, please do so through your host dashboard immediately. This will help avoid delays in the approval process and ensure compliance.</p>
