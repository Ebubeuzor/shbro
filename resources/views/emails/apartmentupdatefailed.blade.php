...
<head>
    ...
    <title>Apartment Update Failed - Action Required</title>
    <style>
...
<body style="margin: 0 !important; padding: 0 !important; background-color: #f4f4f4;" bgcolor="#f4f4f4">
    <div style="display: none; font-size: 1px; color: #fefefe; line-height: 1px; font-family: Arial, sans-serif; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">
        Apartment Update Failed - Action Required
    </div>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td align="center" style="font-size: 24px; font-family: Arial, sans-serif; color: #333333; padding-top: 30px; padding-bottom: 20px;" class="padding">
                                        <strong>Apartment Update Failed</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Arial, sans-serif; color: #666666;" class="padding">
                                        <p>Hello {{$user->name}},</p>
                                        <p>We regret to inform you that there was an issue while trying to update your apartment listing. Unfortunately, the system encountered an error and the update process could not be completed.</p>
                                        <p>We recommend reviewing the information you provided and trying again. If the issue persists, please do not hesitate to reach out to our support team for assistance.</p>
                                        <p>We apologize for any inconvenience caused and are here to help you resolve this as quickly as possible.</p>
                                        <p>To try again or review your account, please visit your host dashboard: <a href="https://shortletbooking.com/host-dashboard" style="color: #4CAF50; text-decoration: none;">Link to Host Dashboard</a>.</p>
