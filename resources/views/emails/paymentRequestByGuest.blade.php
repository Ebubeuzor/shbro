...
<head>
    ...
    <title>Payment Request Submitted by Guest</title>
    <style>
...
<body style="margin: 0 !important; padding: 0 !important; background-color: #f4f4f4;" bgcolor="#f4f4f4">
    <div style="display: none; font-size: 1px; color: #fefefe; line-height: 1px; font-family: Arial, sans-serif; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">
        Payment request submitted by guest - please review.
    </div>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td align="center" style="font-size: 24px; font-family: Arial, sans-serif; color: #333333; padding-top: 30px; padding-bottom: 20px;" class="padding">
                                        <strong>Payment Request Submitted by Guest</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Arial, sans-serif; color: #666666;" class="padding">
                                        <p>Hello Team,</p>
                                        <p>A transaction for one of our guests requires administrative review and approval according to our standard verification procedures. Please find the details below and ensure timely handling of this matter.</p>
                                        
                                        <p><strong>Payment Request Details</strong></p>
                                        <ul style="padding-left: 20px;">
                                            <li><strong>Amount Requested</strong>: {{$useramount}}</li>
                                            <li><strong>Requested On</strong>: {{$formattedDate}}</li>
                                        </ul>
                                        
                                        <p>Ensure the transaction details align with our booking and payment policies. If the transaction passes all checks, approve the payment to finalize the booking or security deposit process.</p>
