                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td align="center" style="font-size: 24px; font-family: Arial, sans-serif; color: #333333; padding-top: 30px; padding-bottom: 20px;" class="padding">
                                        <strong>Welcome to Shrbo, {{$user->name}}!</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Arial, sans-serif; color: #666666;" class="padding">
                                        <p>Hi {{$user->name}},</p>
                                        <p>Welcome to Shrbo! We are thrilled to have you as part of our community.</p>
                                        ...
                                        <p>If you have any questions or need assistance, our support team is always here to help. Just reach out to us at info@shortletbooking.com .</p>
                                        <p>Looking forward to seeing you around!</p>
