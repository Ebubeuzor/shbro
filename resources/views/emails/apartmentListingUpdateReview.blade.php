...
<head>
    ...
    <title>Your Apartment Listing Update Is Under Review</title>
    <style>
...
<body style="margin: 0 !important; padding: 0 !important; background-color: #f4f4f4;" bgcolor="#f4f4f4">
    <div style="display: none; font-size: 1px; color: #fefefe; line-height: 1px; font-family: Arial, sans-serif; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">
        Your Apartment Listing Update Is Under Review
    </div>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td align="center" style="font-size: 24px; font-family: Arial, sans-serif; color: #333333; padding-top: 30px; padding-bottom: 20px;" class="padding">
                                        <strong>Your Apartment Listing Update Is Under Review</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Arial, sans-serif; color: #666666;" class="padding">
                                        <p>Hello {{$user->name}},</p>
                                        <p>We have received the recent updates you submitted for your apartment listing on Shrbo. Your updates are now under review by our administrative team to ensure everything is in line with our standards and policies.</p>
                                        <p><strong>Listing Name:</strong> {{$hosthome->title}}</p>
                                        <p>The review process typically takes 48 hours. Once approved, the updates will be live on the Shrbo website, and guests will be able to view the latest information about your property.</p>
                                        <p>If these changes were made in error or if you need to make additional updates, please reach out to us or modify the details directly through your host management portal as soon as possible.</p>
                                        <p>Thank you for keeping your listings up-to-date and ensuring a great experience for your guests. We appreciate your cooperation and commitment to quality.</p>
