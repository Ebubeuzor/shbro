...
<head>
    ...
    <title>Welcome to Your Home Away from Home – You've Checked In!</title>
    <style>
...
<body style="margin: 0 !important; padding: 0 !important; background-color: #f4f4f4;" bgcolor="#f4f4f4">
    <div style="display: none; font-size: 1px; color: #fefefe; line-height: 1px; font-family: Arial, sans-serif; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">
        Welcome to Your Home Away from Home – You've Checked In!
    </div>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td align="center" style="font-size: 24px; font-family: Arial, sans-serif; color: #333333; padding-top: 30px; padding-bottom: 20px;" class="padding">
                                        <strong>Welcome to Your Home Away from Home – You've Checked In!</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Arial, sans-serif; color: #666666;" class="padding">
                                        <p>Hello {{$user->name}},</p>
                                        <p>Welcome to your cozy Shrbo apartment! You have successfully checked in to the {{$hosthome->title}}, and we are thrilled to have you as our guest. We hope you have a delightful and comfortable stay with us.</p>
                                        <p>Should you have any questions about your apartment's features, need tips on making the most of your stay, or if you encounter any issues, please contact us immediately. Our dedicated guest support team is available 24/7 to assist you.</p>
                                        <p>You can reach us via our support hotline at +2347080646809 or email us at info@shortletbooking.com. We're here to ensure your experience is nothing short of exceptional.</p>
                                        <p>Enjoy every moment of your stay and make the most of your home away from home.</p>
